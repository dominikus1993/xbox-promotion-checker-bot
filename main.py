...
filter_games = filter_gamaes(["Biomutant", "Elden Ring"], ["Cyberpunk 2077", "Red Dead Redemption 2", "Wiedźmin 3: Dziki Gon", "Wiedźmin 3: Dziki Gon – Edycja Gry Roku"], lambda x: x.is_big_promotion() and x.is_ok_game())
logging.info("Start")
